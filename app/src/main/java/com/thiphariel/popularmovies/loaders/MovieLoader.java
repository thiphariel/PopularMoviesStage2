package com.thiphariel.popularmovies.loaders;
...
import com.thiphariel.popularmovies.utilities.VolleySingleton;
...
public class MovieLoader extends Loader<JSONObject> {
    ...
    public MovieLoader(Context context, ProgressBar loadingIndicator, LinearLayout noInternet, String url) {
        super(context);
